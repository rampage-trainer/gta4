        ...
        <div className="self-start mt-6 md:mt-10 flex flex-col gap-6">
            ...
            <div className="grid gap-4">
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  <div className="font-medium">GTA4 EFLC</div>
                  <div className="text-muted-foreground">Build 1.2.0.59</div>
                </div>
          ...
          <div className="space-y-4">
            <p className="text-sm text-muted-foreground max-w-prose">
              Modern trainer with a minimal UI. Download preview builds, read changelogs, and follow install instructions.
            </p>
